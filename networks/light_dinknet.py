...
class DecoderBlock(nn.Module):
    def __init__(self, in_channels, n_filters):
        ...
        '''
        self.deconv2 = nn.ConvTranspose2d(in_channels // 4, in_channels // 4, 3, stride=2, padding=1, groups=in_channels // 4, output_padding=1)
        ...
        self.conv3 = nn.Conv2d(in_channels // 4, in_channels // 4, 3, stride=1, padding=1, groups=in_channels // 4)
        self.norm3 = nn.BatchNorm2d(in_channels // 4)
        self.relu3 = nonlinearity

        self.conv4 = nn.Conv2d(in_channels // 4, in_channels // 4, 1)
        self.norm4 = nn.BatchNorm2d(in_channels // 4)
        self.relu4 = nonlinearity

        self.conv5 = nn.Conv2d(in_channels // 4, n_filters, 1)
...
class Light_DinkNet34(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        super(Light_DinkNet34, self).__init__()
